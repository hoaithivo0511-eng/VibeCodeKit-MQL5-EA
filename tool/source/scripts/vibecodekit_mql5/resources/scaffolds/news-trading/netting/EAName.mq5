...
//| {{NAME}}.mq5                                                      |
//|                                                                   |
//| Scaffold:  news-trading / netting                                       |
//| Symbol:    {{SYMBOL}}                                              |
//| Timeframe: {{TF}}                                                  |
//|                                                                   |
//| News-driven straddle: bracket pending orders ahead of releases.
//|                                                                   |
//| digits-tested: 5, 3                                                |
//+------------------------------------------------------------------+
...
int OnInit(void)
  {
   ...
   // Calendar API hooks live in OnTimer().
