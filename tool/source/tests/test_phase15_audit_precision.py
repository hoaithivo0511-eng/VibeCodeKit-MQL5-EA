...
def test_current_mql5_pending_order_apis_are_not_legacy():
    src = (
        "for(int i=OrdersTotal()-1;i>=0;i--){ulong t=OrderGetTicket(i);if(t>0&&OrderSelect(t)){} }"
    )
    ...
    ir = from_dict(
        {
            ...
            "requirements": [
                {
                    "id": "R1",
                    "path": "strategy.entry.signals.rsi",
                    "value": True,
                    "priority": "must",
                    "status": "confirmed",
                    "confidence": 1.0,
            ...
            "strategy": {
                "parameters": {"signal_mode": "rsi", "dca_mode": "step", "lot_mode": "multiply"}
            },
            "risk": {"max_lot": 1.0},
        }
    )
    ...
    ir = from_dict(
        {
            ...
            "requirements": [
                ...
                {
                    "id": "R3",
                    "path": "strategy.dca.step_multiplier",
                    "value": True,
                    "priority": "must",
                    "status": "confirmed",
                    "confidence": 1.0,
            ...
            "strategy": {
                "parameters": {
                    "signal_mode": "rsi",
                    "dca_mode": "step_multiplier",
                    "dca_switch_count": 10,
                    "dca_secondary_mode": "signal",
                    "lot_mode": "multiply",
                }
            },
            "risk": {"max_lot": 1.0},
