...
// Generated from EA-IR e2c9b9d14c80940a9ccd7af112bc1748578385fdd2fc39a6fb3dfeb7c4389f2a
#pragma once
...
sinput long InpMagic=915880;
sinput string InpTradeSymbol="GBPUSD";
sinput ENUM_TIMEFRAMES InpSignalTimeframe=PERIOD_M30;
sinput VCKSignalMode InpSignalMode=VCK_SIGNAL_BB_REVERSION;
...
sinput int InpMaxBuyPositions=3;
sinput int InpMaxSellPositions=3;
sinput int InpMaxLevelsBuy=3;
sinput int InpMaxLevelsSell=3;
