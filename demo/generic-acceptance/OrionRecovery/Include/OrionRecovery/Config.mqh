...
// Generated from EA-IR 3fc409373ebdfc2af01f98d86c67033d7344cef1961f47e6fa1e677be8d24ba0
#pragma once
...
sinput long InpMagic=919838;
sinput string InpTradeSymbol="EURUSD";
sinput ENUM_TIMEFRAMES InpSignalTimeframe=PERIOD_H1;
sinput VCKSignalMode InpSignalMode=VCK_SIGNAL_RSI;
...
sinput double InpMaxSpreadPips=2.00;
sinput int InpMaxBuyPositions=10;
sinput int InpMaxSellPositions=10;
sinput int InpMaxLevelsBuy=10;
sinput int InpMaxLevelsSell=10;
...
sinput int InpHedgeZoneTriggerPositions=6;
sinput double InpHedgeZoneLotMultiplier=0.50;
sinput double InpHedgeZoneDistancePips=20.00;
sinput double InpHedgeZoneTargetMoney=15.00;
...
sinput double InpCmd_PAUSE_ENGINE=32123.25000000;
const ENUM_ORDER_TYPE VCK_CMD_PAUSE_ENGINE_TYPE=ORDER_TYPE_BUY_LIMIT;
sinput double InpCmd_RESUME_ENGINE=32124.75000000;
const ENUM_ORDER_TYPE VCK_CMD_RESUME_ENGINE_TYPE=ORDER_TYPE_SELL_STOP;
